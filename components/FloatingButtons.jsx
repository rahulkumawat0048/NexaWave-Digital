      ...
      {visible && (
        ...
        >
          ...
          <motion.a
            ...
            className="group relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#1ebe5c] rounded-full shadow-xl shadow-[#25D366]/40"
          ...
          >
            ...
            <motion.span 
              className="absolute right-16 whitespace-nowrap bg-gray-900 text-white text-xs font-medium px-3 py-1.5 rounded-lg shadow-lg pointer-events-none"
          ...
          <motion.a
            ...
            className="group relative flex items-center justify-center w-14 h-14 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 hover:from-orange-600 hover:via-red-600 hover:to-pink-600 rounded-full shadow-xl shadow-orange-500/40"
            whileHover={{ scale: 1.15, rotate: 5 }}
            whileTap={{ scale: 0.9 }}
          >
