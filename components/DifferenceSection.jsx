        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
          {features.map((feat) => {
            ...
            return (
              <div
                key={feat.title}
                className="group relative bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-gray-100/50 hover:border-transparent hover:shadow-2xl transition-all duration-300 cursor-default hover:-translate-y-2"
              >
                <div className={`absolute inset-0 rounded-xl bg-gradient-to-br ${feat.bgGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                <div className={`absolute -inset-1 rounded-xl bg-gradient-to-r ${feat.gradient} opacity-0 group-hover:opacity-10 blur-2xl transition-opacity duration-300`} />
                ...
                <div className="relative flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm font-bold text-gray-900 mb-1 group-hover:text-orange-500 transition-colors duration-300">
                      {feat.title}
                    </h3>
